...
//		$this->remap_featured_images();
		...
		function import_options() {
			...
			<form action="<?php echo admin_url( 'admin.php?import=wordpress&amp;step=2' ); ?>" method="post">
				...
				<?php if ( $this->allow_fetch_attachments() ) : ?>
					...
					<p>
						<input type="checkbox" value="1" name="fetch_attachments" id="import-attachments"/> <label for="import-attachments"><?php _e( 'Download and import file attachments', 'wordpress-importer' ); ?></label>
					</p>
				<?php endif; ?>
		...
		function process_posts() {
			...
			//require dirname( __FILE__ ) . '/lost_array.php';
